package com.xgame.service.website;
 ...
 */
public class XGameWebsiteMainShell {

    public static void main(String[] args) {

        try {
            System.out.println("start web server ...");
            final String appDir = new XGameWebsiteMainShell().getWebAppsPath();
            final Server server = new Server(ServiceConfiguration.getInstance().getConfig().getInt("xgame.mobwalker.service.port", 9100));
